...
earlier `hypernets` scaffold, now folded in). The text family arrived in
0.3.0 (2026-09-01) from the `texthypergraph` package, which is retired;
its generic hypergraph methods (PageRank, projections, null models,
sparse engines, neural tier) joined the hypergraph family, and the merge
