...
The per-state `data.frame` (as
[`as.data.frame()`](https://rdrr.io/r/base/as.data.frame.html) returns
it), with the attractor, the stickiest state and the chain's Kemeny
constant attached as attributes. Returned **invisibly**: `summary(x)`
prints the summary; assign the result to keep the table.
